        ...
        <div className="flex w-full min-h-screen">
          <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-gradient-to-tr from-indigo-800 to-purple-700 text-white p-12">
            <div className="max-w-md text-center">
                ...
                <h1 className="text-4xl font-bold tracking-tight">Sistema de Gestão Clínica</h1>
                <p className="mt-4 text-lg text-indigo-200">
                    Centralize a gestão da saúde com eficiência e segurança. A nossa plataforma une todas as suas unidades.
                </p>
            </div>
          </div>
            ...
            <div className="w-full max-w-sm">
              ...
              <form className="space-y-6" onSubmit={handleLogin}>
                <div className="relative">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Endereço de email</label>
                  ...
                  <input id="email" name="email" type="email" autoComplete="email" required
                    ...
                    placeholder="exemplo@dominio.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                <div className="relative">
